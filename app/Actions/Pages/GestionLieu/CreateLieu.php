...
class CreateLieu
{
    public function handle(array $validated, int $typePavilion, int $typeChambre): Onou_cm_lieu
    {
        $lieu = Onou_cm_lieu::create([
        ...
        // Optional: Handle chambres if it's a pavilion
