<x-layouts.app :title="__('Dashboard')" >
     <x-common.container>
            <x-common.grid :gap="2" :columns="4">
                    ...
                    <div class="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
                        <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">1219</h5>
                                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Demande en cours</p>
                                </div>
                            </div>
                            <div>
                ...
                <x-common.card class="col-span-5">
